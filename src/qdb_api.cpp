...
void InitConstants(v8::Local<v8::Object> exports)
{
    ...
    quasardb::detail::AddConstantProperty(
        isolate, exports, "NEVER_EXPIRES", v8::Int32::New(isolate, qdb_never_expires));
    quasardb::detail::AddConstantProperty(
        isolate, exports, "PRESERVE_EXPIRATION", v8::Int32::New(isolate, qdb_preserve_expiration));
