...
private:
    Integer(cluster_data_ptr cd, const char * alias)
        : ExpirableEntry<Integer>(cd, alias)
    {
    }
...
public:
    ...
    {
        ExpirableEntry<Integer>::Init(exports, "Integer",
...
public:
        ...
        ExpirableEntry<Integer>::queue_work(
            ...
            [](qdb_request * qdb_req)
            {
                qdb_req->output.error =
                    qdb_int_get(qdb_req->handle(), qdb_req->input.alias.c_str(), &(qdb_req->output.content.value));
            },
    ...
    static void add(const v8::FunctionCallbackInfo<v8::Value> & args)
    {
        ExpirableEntry<Integer>::queue_work(
            ...
            [](qdb_request * qdb_req)
            {
                qdb_req->output.error = qdb_int_add(qdb_req->handle(), qdb_req->input.alias.c_str(),
